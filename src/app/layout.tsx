          ...
          <header className="sticky top-0 z-50 w-full bg-[#EEFFFD] shadow-sm" style={{ minHeight: '8vh' }}>
            <div className="max-w-7xl mx-auto flex items-center justify-between px-4" style={{ minHeight: '8vh', paddingTop: '0.5rem', paddingBottom: '0.5rem' }}>
              ...
              <div className="flex items-center space-x-3 min-w-[180px] justify-end">
                <a href="/auth/signin" className="px-4 py-2 rounded font-semibold text-white bg-[#00C9A1] hover:bg-[#009e7c] transition shadow-sm">Sign In</a>
                <a href="/auth/signup" className="px-4 py-2 rounded font-semibold text-white bg-[#00C9A1] hover:bg-[#009e7c] transition shadow-sm border border-[#00C9A1]">Register</a>
              </div>
            </div>
          </header>
          {/* Search Section */}
